...
-- 도서정보
ALTER TABLE library.Book_Information
...
-- 대출/반납
CREATE TABLE library.RENTAL_RETURN (
	P_NO      INT(5) NOT NULL COMMENT '회원번호', -- 회원번호
	B_NO      INT(5) NOT NULL COMMENT '도서번호', -- 도서번호
